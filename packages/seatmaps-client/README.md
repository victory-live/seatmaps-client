...
**Support:** questions, bug reports and feature requests go to [Ticket Evolution support](https://www.ticketevolution.com/contact-us/). Releases are listed in the [changelog](https://www.npmjs.com/package/@victory-live/seatmaps-client?activeTab=code) shipped with the package (`CHANGELOG.md`).
